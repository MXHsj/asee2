...
class FitQuadraticSurface():
    ...
    def fit_quadratic_plane(self, pcd):
        x = pcd[:, 0]
        y = pcd[:, 1]
        z = pcd[:, 2]
    ...
    def calculate_quadratic_surface_normal(self, coeffs, x, y):
        """
    ...
    def sample_quadratic_surface(self, coeffs, x_range, y_range, resolution=30):
        a, b, c, d, e, f = coeffs
